...
import { Menu, LogOut, LayoutDashboard, Users, Settings, Database, Activity } from "lucide-react";
    ...
    <div className="flex h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 text-white">
      ...
      >
        <div className="p-6 border-b border-gray-700 flex items-center justify-between">
          ...
          <button className="md:hidden text-gray-400 hover:text-white" onClick={() => setOpen(false)}>✕</button>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        <Topbar title="Admin Panel" theme="gray" onMenuClick={() => setOpen(!open)} />
