...
import { useApplicationSync } from "@/hooks/useApplicationSync"; // ✅ Added live sync
...
const StaffDashboard: React.FC = () => {
  ...
  const downloadAuditLogs = () => {
    ...
    link.setAttribute("download", `staff_audit_${new Date().toISOString()}.csv`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-green-50 to-secondary/5 p-6">
      <div className="container mx-auto">
        <h1 className="text-2xl font-bold mb-4 text-foreground">Staff Dashboard</h1>
        ...
        <div className="grid md:grid-cols-4 gap-4 mb-6">
          ...
          <Card className="p-4 text-center">
            ...
            <p className="text-sm mt-2">System Health</p>
                  ...
                  {applications.map((a) => (
                    <tr key={a.id} className="border-b hover:bg-muted/30">
                      ...
                      <td className="p-3 flex gap-2">
                        ...
                        <Button
                          size="sm"
                          onClick={() => openDialog(a.id, "Approved", "Approved by staff.")}
                        >
                        ...
                        <Button
                          size="sm"
                          variant="destructive"
                          onClick={() => openDialog(a.id, "Rejected", "Rejected by staff.")}
                        >
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Provide a note for this staff-level action.
            </DialogDescription>
          </DialogHeader>
          <Textarea
            value={actionNotes}
